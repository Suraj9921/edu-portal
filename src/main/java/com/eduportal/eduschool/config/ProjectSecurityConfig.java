package com.eduportal.eduschool.config;

import com.eduportal.eduschool.handler.CustomAuthenticationFailureHandler;
import com.eduportal.eduschool.handler.CustomAuthenticationSuccessHandler;
...
public class ProjectSecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        ...
        UserDetails admin = User.withUsername("admin")
                .password("{bcrypt}$2a$12$FTdQeR4dG6l3J39KG5WEg.eMYQihP0B8Ex4TAI3rA7mPDJr36Jx/G")
